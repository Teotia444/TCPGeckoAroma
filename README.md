...
* `poke -t (type: u8, u16, u32, f32) -a (address: 0xXXXXXXXX) -v (value: 0xXX) -k` : pokes an address interpreted as the specified type with the specified value. `-k`: kernel mode (allows poking read-only addresses)
